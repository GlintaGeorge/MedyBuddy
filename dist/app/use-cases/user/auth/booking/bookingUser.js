...
exports.updateBookingStatusPayment = exports.getBookingByDoctorId = exports.changeWallet = exports.changeWalletAmounti = exports.walletDebit = exports.getWalletBalance = exports.changeAppoinmentstaus = exports.getBookingByUserId = exports.getBookingByBookingId = exports.updateBookingStatus = exports.createPayment = exports.changeAppoinmentStatus = exports.checkIsBooked = exports.appoinmentBooking = void 0;
...
const appoinmentBooking = (data, userId, bookingDbRepository, doctorDbRepository) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const appoinment = (0, bookingEntity_1.default)(userId, doctorId, patientName, patientAge, patientNumber, patientGender, patientProblem, fee, paymentStatus, appoinmentStatus, appoinmentCancelReason, date, timeSlot);
...
const createPayment = (userName, email, bookingId, totalAmount) => __awaiter(void 0, void 0, void 0, function* () {
    const stripe = new stripe_1.default("sk_test_51PSbs6K4DaQ8xohLU8Oi3LXyXXCLyGDMIsfcJkaPQLPfXyqbvUGq6PF21V31BmYaDnCvpazADNw144Rj6pgoAlWk00dfTpLqmc");
    ...
    console.log(config_1.default.CLIENT_PORT);
