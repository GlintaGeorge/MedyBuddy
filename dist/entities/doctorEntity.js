...
function doctorEntity(doctorName, email, password, verificationToken, phoneNumber, department, 
// consultationType:string,
education, description, experience, rejectedReason, lisenceCertificate) {
    return {
