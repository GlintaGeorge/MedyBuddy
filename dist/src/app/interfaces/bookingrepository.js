...
const bookingDbRepository = (repository) => {
    ...
    const checkBookingStatus = (doctorId, date, timeSlot) => __awaiter(void 0, void 0, void 0, function* () { return yield repository.changeBookingStatus(doctorId, date, timeSlot); });
