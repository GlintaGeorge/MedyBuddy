...
exports.clearNotification = exports.notification = exports.getMessages = exports.getChats = void 0;
...
const notification = (userId, chatRepository) => __awaiter(void 0, void 0, void 0, function* () {
    return yield chatRepository.notification(userId);
});
exports.notification = notification;
const clearNotification = (userId, chatRepository) => __awaiter(void 0, void 0, void 0, function* () {
    return yield chatRepository.clearNotification(userId);
});
